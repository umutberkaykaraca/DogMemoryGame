...
part of 'easy_game_view_model.dart';
...
mixin _$EasyGameViewModel on _EasyGameViewModelBase, Store {
  Computed<String>? _$timeComputed;

  @override
  String get time => (_$timeComputed ??= Computed<String>(() => super.time,
          name: '_EasyGameViewModelBase.time'))
      .value;

  final _$timerAtom = Atom(name: '_EasyGameViewModelBase.timer');
  ...
  final _$minuteAtom = Atom(name: '_EasyGameViewModelBase.minute');
  ...
  final _$secondAtom = Atom(name: '_EasyGameViewModelBase.second');
  ...
  final _$kopkeAtom = Atom(name: '_EasyGameViewModelBase.kopke');
  ...
  final _$cardStateKeysAtom =
      Atom(name: '_EasyGameViewModelBase.cardStateKeys');
  ...
  final _$kopke1Atom = Atom(name: '_EasyGameViewModelBase.kopke1');
  ...
  final _$kopke2Atom = Atom(name: '_EasyGameViewModelBase.kopke2');
  ...
  final _$kopke1indexAtom = Atom(name: '_EasyGameViewModelBase.kopke1index');
  ...
  final _$kopke2indexAtom = Atom(name: '_EasyGameViewModelBase.kopke2index');
  ...
  final _$numberOfMoveAtom = Atom(name: '_EasyGameViewModelBase.numberOfMove');
  ...
  final _$numberOfMatchesAtom =
      Atom(name: '_EasyGameViewModelBase.numberOfMatches');
  ...
  final _$scoreAtom = Atom(name: '_EasyGameViewModelBase.score');
  ...
  final _$addGameDataAsyncAction =
      AsyncAction('_EasyGameViewModelBase.addGameData');
  ...
  final _$_EasyGameViewModelBaseActionController =
      ActionController(name: '_EasyGameViewModelBase');

  @override
  void backOnPressed() {
    final _$actionInfo = _$_EasyGameViewModelBaseActionController.startAction(
        name: '_EasyGameViewModelBase.backOnPressed');
    try {
      return super.backOnPressed();
    } finally {
      _$_EasyGameViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  void startTimer() {
    final _$actionInfo = _$_EasyGameViewModelBaseActionController.startAction(
        name: '_EasyGameViewModelBase.startTimer');
    try {
  ...
  void queue() {
    final _$actionInfo = _$_EasyGameViewModelBaseActionController.startAction(
        name: '_EasyGameViewModelBase.queue');
    try {
      return super.queue();
    } finally {
      _$_EasyGameViewModelBaseActionController.endAction(_$actionInfo);
  ...
  void cardKeys() {
    final _$actionInfo = _$_EasyGameViewModelBaseActionController.startAction(
        name: '_EasyGameViewModelBase.cardKeys');
    try {
  ...
  void onTap(dynamic index) {
    final _$actionInfo = _$_EasyGameViewModelBaseActionController.startAction(
        name: '_EasyGameViewModelBase.onTap');
    try {
  ...
  void onFlip(String kopke, int index) {
    final _$actionInfo = _$_EasyGameViewModelBaseActionController.startAction(
        name: '_EasyGameViewModelBase.onFlip');
    try {
